...
<script>
    ...
    // Function to retrieve school locations from the server
    function getSchoolLocations(school_id, district_id, tehsil_id, cities_id) {
        console.log("Fetching school locations...");

        $.ajax({
            url: '/admin/geolocator/map/ajax',
            type: 'GET',
            data: {
                school_id: school_id,
            ...
            success: function(data) {
                console.log("School locations fetched:", data);
                ...
                data.forEach(function(school) {
                    ...
                    var infowindow = new google.maps.InfoWindow({
                        content: `<strong>${school.school_name}</strong><br>${school.city_name}<br><a href="/admin/school/${school.sc_br_id}">Click for More Info</a>`
                    });
    ...
    function initMap(lat,long) {
        ...
        getSchoolLocations(null, null, null, null);
    }
    ...
    $('#search_map').click(function() {
        ...
        // Call the function to load school locations based on selected filters
        getSchoolLocations(school_id, district_id, tehsil_id, cities_id);
    });
